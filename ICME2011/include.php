...
<title>2011 IEEE Internation Conference on Multimedia &amp; Expo (ICME 2011)</title>
...
<div id="navigate">';
	...
	echo '<hr/>';
	echoLink('barcelonainfo.php','Barcelona Information');
...
function echoEnd(){
	echo '</div>
<div id="copyright">&copy;Copyright 2010-2011 IEEE ICME | ieee.icme2011@gmail.com | Website template designed by Tammam Nima</div>
</body>
</html>';
}
