...
<div id="container">
    ...
    <div id="main">
        ...
        <ul>
            <li> Speech, audio, image, video, text and new sensor signal processing</li>
            <li> Signal processing for media integration</li>
            <li> Interactive 3D media and immersive VR/AR environments</li>
            <li> Multi-modal multimedia computing systems and human-machine interaction</li>
            <li> Multimedia Cloud and Big Data</li>
            <li> Multimedia IoT</li>
            <li> Mobile Multimedia Systems and Applications</li>
            <li> Multimedia compression</li>
            <li> Multimedia security, privacy, and content protection</li>
            <li> Multimedia databases and digital libraries</li>
            <li> Multimedia applications and services</li>
            <li> Media content analysis, analytics, and search</li>
            <li> Hardware and software for multimedia systems</li>
            <li> MMultimedia standards and related issues</li>
